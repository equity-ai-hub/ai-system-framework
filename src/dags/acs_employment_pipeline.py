...
with DAG(
    "employment_task_pipeline",
    description="ML Pipeline: ACSEmployment Task",
    ...
    # the user can train more models and also evaluate them following the same pattern as xgboost
    ...
    (
        ...
        >> process
        >> train_xgboost
        >> [baseline_model_eval, separation_intv_eval, indenpendence_intv_eval, sufficiency_intv_eval]
    )
